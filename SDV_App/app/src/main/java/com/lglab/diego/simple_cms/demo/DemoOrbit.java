...
public class DemoOrbit extends TobBarActivity {

    private static final String TAG_DEBUG = "DemoOrbit";
    ...
    private void getDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(DemoOrbit.this);
        ...
        ok.setOnClickListener(view -> {
            stopDemo();
            CustomDialogUtility.showDialog(DemoOrbit.this, getResources().getString(R.string.stop_message));
        });
    ...
    private void testStoryboard(List<Action> actionsSaved) {
        ...
        handler.postDelayed(() -> {
            if (isConnected.get()) {
                dialog.show();
                demoThread = new DemoThread(actionsSaved, DemoOrbit.this, dialog);
                demoThread.start();
            }
            loadConnectionStatus(sharedPreferences);
        }, 1200);
